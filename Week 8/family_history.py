...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    for line in people_dict:
        person = people_dict[line]
        name = person[0]
        date_birth = person[2]
        date_death = person[3]

        age_at_death = date_death - date_birth
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    for line in marriages_dict:
        marriage = marriages_dict[line]
        male_code = marriage[0]
        female_code = marriage[1]
        wedding_year = marriage[2]

        husband = people_dict[male_code]
        wife = people_dict[female_code]
        H_age = wedding_year - husband[2]
        W_age = wedding_year - wife[2]
        print(f"{husband[0]}, {H_age}, {wedding_year}, {wife[0]}, {W_age}")
