...
def main():
    ...
    filename = try_input("Name of file that contains NHTSA data: ")
    with open(filename, "rt") as text_file:

        # Prompt the user for a percentage.
        perc_reduc = float(number_input("Percent reduction of texting while driving [0, 100]: "))
...
def try_input(msg):
    while True:
        try:
            ...
            print("Could not find the file your looking for.")
...
def number_input(msg):
    while True:
        try:
            ...
            print("Could not convert a string.")
